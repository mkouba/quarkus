...
Sometimes when testing you only need to verify that a certain logical path was taken, or you only need to override a single method and want the rest of the methods to be called normally.

...
public final class ValueResolvers {
    ...
    public static final class MapperResolver implements ValueResolver {
        ...
        public boolean appliesTo(EvalContext context) {
            if (ValueResolvers.hasNoParams(context) && ValueResolver.matchClass(context, Mapper.class)) {
                return ValueResolvers.<Mapper> base(context).appliesTo(context.getName());
            }
            return false;
        }
        ...
        @Override
        public CompletionStage<Object> resolve(EvalContext context) {
            return ValueResolvers.<Mapper> base(context).getAsync(context.getName());
        }
    }
